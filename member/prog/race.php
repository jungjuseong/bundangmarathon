...
//echo "dbquery=".$dbquery;
	...
	while($row=mysql_fetch_array($result)){
		echo "<tr><td><a href='inviting.php?mode=record-list2&raceid=$row[0]'>$row[1]</a>\n";
...
<tr><td>대회약칭</td><td><input type=text name=nickname value='$nickname' maxlength=12 size=12 onChange='return checkLength(this.value,12)'>연도 2자리 + 빈칸 + 장소(예 : 01 동아, 01 생체 진천)</td></tr>\n
...
<tr><td>장소</td><td><input type=text name=place  value='$place' maxlength=20 size=20 onChange='return checkLength(this.value,20)'></td></tr>\n
<tr><td>종목및참가비</td><td><input type=text name=typenfee value='$typenfee' maxlength=40 size=40 onChange='return checkLength(this.value,40)'></td></tr>\n
