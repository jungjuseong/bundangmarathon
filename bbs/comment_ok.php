...
//yhkim start : 원본은 write_ok.php(2군데 수정), spam 댓글 방지
// photo : vote_ex.php
...
//		ContentSave();
		Error("사용권한이 없습니다...","login.php?id=$id&page=$page&page_num=$page_num&category=$category&sn=$sn&ss=$ss&sc=$sc&keyword=$keyword&no=$no&file=$view_file_link");
	}
