...
<!--
<p><a href='/member/subscribe.html'>분당마라톤 클럽 회원 가입 안내</a> </p>
<p>회비 입금 계좌 : 국민은행 079-21-0501-216(서상철)</p>
-->
<p>다음은 현 회원 명단입니다. 수정 사항이 있는 회원은 <a href='mailto:san2run@paran.com'>홈페이지
...
*/
	...
	if($membertype != "예비회원")
		echo "<tr><td>사진<td><img src='$photo_dir/$row[6]' border=0>";
	if($row[15] != "")
		bostonrace($row[15], "0");
	echo "\n";
...
//	mysql_close($connect);
	...
	if($result!="1"){
		...
		$cont.= "가입소감: $etc\n";
		mailsend($name, $email, "분당마라톤클럽총무", $managerEmail, "신규 가입 신청 - $name", $cont);
	}
