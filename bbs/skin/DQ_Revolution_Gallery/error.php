...
<tr><td align=center>
	...
	<tr><td class=info_bg>
		...
		<tr><td height=30>
		<? if(!$url){ ?>
		  <div align=center><a href=# onclick=history.back() onfocus=blur()><font class=han>[이전 화면]</font></a></div>
			<? } else { ?>			<div align=center><a href=# onclick=location.href="<?echo $url;?>" onfocus=blur()><font class=han>[페이지 이동]</font></a></div>
