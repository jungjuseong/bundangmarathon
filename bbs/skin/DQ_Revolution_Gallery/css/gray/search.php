...
<tr>
	...
	<td><input type=image src=<?=$_css_dir?>bt_search.gif class='submit'></td>
	<td><input type=image src=<?=$_css_dir?>bt_cancel.gif onclick="location.href='zboard.php?id=<?=$id?>'" style="cursor:pointer"></td>
</tr>
</table>
