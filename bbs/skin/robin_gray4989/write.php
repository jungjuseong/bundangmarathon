...
<tr>
  ...
  <td><input type=file name=file1 <?=size(50)?> maxlength=255 class=robin_input> <?=$file_name1?>(300kb 이하)</td>
</tr>
<tr>
  ...
  <td><input type=file name=file2 <?=size(50)?> maxlength=255 class=robin_input> <?=$file_name2?>(300Kb 이하)</td>
</tr>
