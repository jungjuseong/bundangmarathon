...
<col width=1></col>
<tr align=center>
	<td hieght=17 widht=1 background=<?=$dir?>/robinweb_topbar_both.gif>
	<?=$hide_cart_start?><td background=<?=$dir?>/robinweb_topbar.gif><table cellspacing=0 cellpadding=0><tr><td align=center><?=$a_cart?><img src=<?=$dir?>/h_cart.gif border=0></a></td></tr></table></td><?=$hide_cart_end?>
	...
	<td widht=1 background=<?=$dir?>/robinweb_topbar_both.gif>
</tr>
