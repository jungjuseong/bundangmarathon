...
<table border=0 width=690 cellsapcing=0 cellpadding=0>
<tr><td>
...
<table border=0 width=685 cellsapcing=0 cellpadding=0 cellspacing=0>
  <tr> 
...
<table border=0 width=680 cellsapcing=1 cellpadding=0 height=1 cellspacing=0><tr><td></td></tr></table>
<table border=0 width=680 cellsapcing=1 cellpadding=0 class=robin_writeform>
...
<tr valign=top>
  ...
  <td><input type=text name=subject value="<?=$subject?>" <?=size(50)?> maxlength=200 style=width:99% class=robin_input>
  </td> 
</tr>

<tr>
	<td colspan=2 style=padding:5px>
		<textarea name="memo" id="memo" rows="19" cols="100" style="width:660px; height:412px; display:none;"></textarea>
			<? echo $memo ?>
		</textarea>
	</td>
</tr>
