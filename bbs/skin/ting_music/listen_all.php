...
var dasomcopyright="<font style=font-size:9pt;>Copyright 2001-2002 </font><a href=http://www.dasomlove.net target=_blink title='http://www.tingstar.com' class='skin'>tingstar.com</a>";
// - JavaScript - -->
</script>
...
if($temp[file_name1]==true){ $arr = array($zero_path,$temp[file_name1]);}
else{
$arr = array($temp[file_name1]);
}
...
$song_smi[$i]="http://addonis0229.netcci.org/no.smi";
