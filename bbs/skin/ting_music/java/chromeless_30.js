...
if(X==null)X=Math.ceil((window.screen.width-W)/ 8)
if(Y==null)Y=Math.ceil((window.screen.height-H)/ 8)
...
'#txtTITLE {position:absolute;left:0px;top:0px;width:100%;height:10px;z-index:1;clip:rect(0,100%,10,0);}\n'+
'#btnCLOSE {position:absolute;left:0px;top:0px;width:20px;height:10px;z-index:3;clip:rect(0,20,10,0);}\n'+
'#btnMINI {position:absolute;left:0px;top:0px;width:20px;height:10px;z-index:3;clip:rect(0,20,10,0);}\n'+
'#grfCLOCK {position:absolute;left:0px;top:0px;width:11px;height:10px;z-index:3;clip:rect(0,11,10,0);}\n'+
'</style>\n'+
...
'<div id=crtMOVE><img onmousedown="winSTATUS=\'down\';moveWIN()" onmouseup="winSTATUS=\'up\';moveWIN()" border=0 src="'+NONEgrf+'" width=100% height=500></div>\n'+
'<div id=txtTITLE>'+'<table width=100% height=6 border=0 cellpadding=0 cellspacing=0><tr><td valign=middle align=left>'+titHTML+'</td></tr></table>'+'</div>\n'+
'<div id=btnCLOSE><img name=imgCLOSE src="'+CLOSEup+'" border=0 width=20 height=10 onmouseover="this.src=imgCLOSEovr.src" onmouseout="btnSTATUS=false;this.src=imgCLOSEup.src" onmouseup="this.src=imgCLOSEup.src" onmousedown="this.src=imgCLOSEdwn.src" onclick="top.window.close()"></div>\n'+
'<div id=btnMINI><img name=imgMINI src="'+MINIup+'" border=0 width=20 height=10 onmouseover="this.src=imgMINIovr.src" onmouseout="btnSTATUS=false;this.src=imgMINIup.src" onmouseup="this.src=imgMINIup.src" onmousedown="this.src=imgMINIdwn.src" onclick="minimizeWIN()"></div>\n'+
...
'<frameset border=0 framespacing=0 frameborder=0 rows="1,6,1,100%,1">\n'+
