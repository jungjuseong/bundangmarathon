...
var displayleft=8; //실시간 가사의 가로위치
var displaytop=387;//실시간 가사의 세로위치
/*★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
...
var trackbarposition=75; //트랙 진행바 초기위치
var trackbarlength=204; //트랙 진행바 초기위치로 부터 이동거리
var trackbartopposition = 10; // 트랙진행바의 세로위치
...
var volposition=404; // 볼륨의 최대크기위치
var volminposition=339; //볼륨의 최소크기 위치
var vollength=66; //볼륨의 이동거리
var voltopposition=10; //볼륨의 최초 높이의 위치
...
var balcenposition=207; //볼륨벨런스의 중간위치
var ballength=22; // ±볼륨벨런스의 좌우이동거리(즉 40은 -40과 +40이란의미이다.
var baltopposition=46; //볼륨벨런스의 최초 높이의 위치
...
var bgmlistwidth=674; //음악 목록창을 새창으로띄울경우 목록창의 가로크기
var bgmlistheight=508; //음악 목록창을 새창으로띄울경우 목록창의 세로크기
...
var bgmlistminw=674; //플래이어를 처음 열었을때 가로크기
var bgmlistminh=508; //플래이어를 처음 열었을때 세로크기
var bgmlistmaxw=674; //음악 목록을 보였을때의 가로크기
var bgmlistmaxh=508; //음악 목록을 보였을때의 세로크기
var bgmlistmvw=bgmlistminw-2; //음악 목록을 보였을때의 가로크기
var bgmlistmvh=bgmlistminh-23; //음악 목록을 보였을때의 세로크기
