...
<tr>
  <td colspan=2 height=32 align=center valign=bottom>◈ 음악 등록하기 ◈<br><img src=images/t.gif height=5></td>
...
<tr>
  ...
  <td align=right class=thm8><b>노래제목&nbsp;</b></td>
  <td> <input type=text name=subject value="<?=$subject?>" <?=size(46)?> maxlength=200 class=input><?=$hide_notice_start?> <input type=checkbox name=notice <?=$notice?> value=1> 공지사항 <?=$hide_notice_end?> <?=$category_kind?></td>
</tr>
<tr><td bgcolor=#ffffff height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr>
  <td align=right class=thm8><b>가사입력&nbsp;</b></td>
  <td valign=top>
...
<tr height=25>
  <td align=right class=thm8><b>음악링크 &nbsp;</b></td>
...
<tr height=25>
  <td align=right class=thm8><b>뮤비링크 &nbsp;</b></td>
...
<tr><td bgcolor=#ffffff height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
  <td align=right class=thm8><b>음악파일 up&nbsp;</b></td>
  <td> <input type=file name=file1 <?=size(50)?> maxlength=255 class=input> <?=$file_name1?></td>
</tr>
<tr><td bgcolor=#ffffff height=1 colspan=2><img src=images/t.gif height=1></td></tr>
<tr height=25>
  <td align=right class=thm8><b>자막파일 up&nbsp;</b></td>
