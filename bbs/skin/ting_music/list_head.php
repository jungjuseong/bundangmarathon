...
<tr align=center>
  <td>
    <table border=0  cellspacing=0 cellpadding=0 width=30 >
       <tr><td align=center valign=top><?=$a_no?><b title="번호 순으로 보기"></b></a></td></tr>
    </table>
  </td>

  <td>
    <table border=0  cellspacing=0 cellpadding=0 width=20>
       <tr><td align=center valign=top><b title="목록 선택">
 </b></td></tr>
    </table>
  </td>
  ...
  <td width=100%>
    <table border=0  cellspacing=0 cellpadding=0 width=100% >
       <tr><td align=center valign=top><?=$a_subject?><b title="제목 순으로 보기"></b></a></td>
<td width=1>
...
<input type=hidden name=sc value="<?=$sc?>">
  ...
  <td>
    <table border=0  cellspacing=0 cellpadding=0 width=50 >
       <tr><td align=center valign=top><?=$a_date?><b title="날짜 순으로 보기"></b></a></td></tr>
    </table>
  </td>
  <td>
    <table border=0  cellspacing=0 cellpadding=0 width=30 >
       <tr><td align=center valign=top><?=$a_hit?><b title="조회 순으로 보기"></b></a></td></tr>
    </table>
  </td>
