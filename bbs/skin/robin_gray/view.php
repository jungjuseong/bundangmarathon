<img src=<?=$dir?>/img/t.gif border=0 height=5><br>
<table border=0 width=<?=$width?> height=17 cellsapcing=0 cellpadding=0 cellspacing=0>
  <tr> 
    <td width=1 background=<?=$dir?>/img/robinweb_topbar_both.gif></td>
    <td background=<?=$dir?>/img/robinweb_topbar.gif><img src=<?=$dir?>/t.gif border=0 height=17></td>
	<td width=1 background=<?=$dir?>/img/robinweb_topbar_both.gif></td>
  </tr>
</table>
...
<tr><td colspan=2 bgcolor=white height=1><img src=<?=$dir?>/img/t.gif border=0 height=1></td></tr>
<tr>
	<td height=22><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr><td align=center><img src=<?=$dir?>/img/w_name.gif></td></tr></table></td>
	<td bgcolor=white>
...
<?=$hide_homepage_start?>
<tr>
	<td height=22><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr><td align=center><img src=<?=$dir?>/img/w_homepage.gif></td></tr></table></td>
...
<tr>
	<td height=22><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr><td align=center><img src=<?=$dir?>/img/w_subject.gif></td></tr></table></td>
...
<img src=<?=$dir?>/img/t.gif border=0 height=2><br>
