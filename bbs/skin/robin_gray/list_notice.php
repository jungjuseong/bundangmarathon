<tr align=center class=zv3_listBox onMouseOver=this.style.backgroundColor='#FBFBFB' onMouseOut=this.style.backgroundColor=''>
    ...
    <td height=30 width=50><img src=<?=$dir?>/img/robinweb_notice.gif border=0></td>
	<td align=left style='word-break:break-all;'>&nbsp;<?=$insert?><?=$icon?><?=$hide_category_start?>[<?=$category_name?>]<?=$hide_category_end?><b><?=$subject?></b> <font class=zv3_comment><?=$comment_num?></font></td> 
