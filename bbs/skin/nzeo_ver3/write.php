<?
	...
	else $title="<font class=view_title1>New </font> <font class=view_title2>Training Plan</font>";
?>
<? //include "se/js/HuskyEZCreator.js"; ?>
...
<tr>
  <td colspan=2 style=padding:5px>
	<textarea id=memo name=memo <?=size2(90)?> rows=18 class=zv3_w_textarea><?=$memo?></textarea>
  </td>
</tr>
